...
export const Menu: React.FC = () => {
    ...
    useEffect(() => {
        ...
        if (context?.app.app.isPhone) {
            timeline
                .from(".menu > div", { duration: 0.5, y: 100, opacity: 0, ease: "expo.inOut", stagger: 0.1 })
                .from(".socials-mobile span", { duration: 0.5, y: 100, opacity: 0, ease: "expo.inOut", stagger: 0.1 })
            ...
            timeline
                .from(".menu > div", { duration: 0.5, y: 100, opacity: 0, ease: "expo.inOut", stagger: 0.1 })
                .from(".socials span", { duration: 0.5, y: 100, opacity: 0, ease: "expo.inOut", stagger: 0.1 })
                .to(".nav-container", { duration: 0.3, left: 0, ease: "expo.inOut" })
                .to(".menu > div", { duration: 0.5, opacity: 1, ease: "expo.out", stagger: 0.1 })
