    ...
    useEffect(() => {
        ...
        if (context?.app.app.isPhone) {
            timeline
                ...
                .to(".menu > div", { duration: 0.3, opacity: 1, ease: "expo.out", stagger: 0.1 })
                .to(".socials-mobile span", { duration: 0.3, opacity: 1, ease: "expo.out", stagger: 0.1 })
        } else {
            timeline
                .to(".nav-container", { duration: 0.3, left: 0, ease: "expo.inOut" })
                .from(".menu > div", { duration: 0.1, y: 100, opacity: 0, ease: "expo.inOut", stagger: 0.1, delay: 0.05 })
                ...
                .to(".menu > div", { duration: 0.3, opacity: 1, ease: "expo.out", stagger: 0.1 })
                .to(".socials span", { duration: 0.3, opacity: 1, ease: "expo.out", stagger: 0.1 })
        }
